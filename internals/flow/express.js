/**
 * Taken from flow-typed.
 * @link https://github.com/flowtype/flow-typed/blob/master/definitions/npm/express_v4.x.x/flow_v0.32.x-/express_v4.x.x.js
 */
...
declare type express$RenderCallback = (err:
        Error
        | null, html?: string) => mixed;
...
declare interface express$RouteMethodType<T> {
    ...
    (path: string
         | RegExp
         | string[], ...middleware: Array<express$Middleware>): T;
}
...
declare class express$Router extends express$Route {
    ...
    use(path:
            string
            | RegExp
            | string[], ...middleware: Array<express$Middleware>): this;
